...
public class Translations {
	...
	public static final Translation MESSAGE_FACTION_KICK_NO_PERMISSIONS = new Translation("kick.error.gui.no-permissions").add(ComponentType.CHAT, text("<red>You do not have permissions to kick in this faction"));
	public static final Translation MESSAGE_FACTION_KICK_CANNOT_KICK_USER = new Translation("kick.error.gui.cannot-kick-higher-member").add(ComponentType.CHAT, text("<red>You cannot kick <white>%who%<red> from the faction"));
	public static final Translation MESSAGE_FACTION_KICK_KICKED = new Translation("kick.error.gui.kicked").add(ComponentType.CHAT, text("<red>Kicked <white>%who%<red> from the faction due to <white>%reason%"));
	public static final Translation MESSAGE_FACTION_KICK_WHO_WAS_KICKED = new Translation("kick.error.gui.kicked-kicked-info").add(ComponentType.CHAT, text("<red>You were kicked by <white>%player%<red> from <white>%faction%<red> due to <white>%reason%"));
	public static final Translation BROADCAST_FACTION_KICK_KICKED = new Translation("kick.error.gui.faction-info").add(ComponentType.CHAT, text("<white>%who%<green> was kicked from the faction by <white>%player%<green> due to <white>%reason%"));

	public static final Translation MESSAGE_FACTION_BAN_NO_PERMISSIONS = new Translation("kick.error.gui.no-permissions").add(ComponentType.CHAT, text("<red>You do not have permissions to ban in this faction"));
	public static final Translation MESSAGE_FACTION_BAN_CANNOT_BAN_USER = new Translation("kick.error.gui.cannot-ban-higher-member").add(ComponentType.CHAT, text("<red>You cannot ban <white>%who%<red> from the faction"));
	public static final Translation MESSAGE_FACTION_BAN_ALREADY_BANNED = new Translation("kick.error.gui.already-banned").add(ComponentType.CHAT, text("<white>%who% <red>is already banned from the faction for <white>%old_reason%"));
	public static final Translation MESSAGE_FACTION_BAN_BANNED = new Translation("kick.error.gui.banned").add(ComponentType.CHAT, text("<red>Banned <white>%who%<red> from the faction due to <white>%reason%"));
	public static final Translation MESSAGE_FACTION_BAN_WHO_WAS_BANNED = new Translation("ban.error.gui.banned-banned-info").add(ComponentType.CHAT, text("<red>You were kicked by <white>%player%<red> from <white>%faction%<red> due to <white>%reason%"));
